...
const formSchema = z.object({
  ...
  title: z.string().min(1, "Bu alan zorunludur.").max(255, "Bu alan en fazla 255 karakter olabilir."),
  image_url: z.string().optional(),
  description: z.string().min(1, "Bu alan zorunludur.").max(2000, "Bu alan en fazla 2000 karakter olabilir."),
  sector: z.string().max(255, "Bu alan en fazla 255 karakter olabilir.").optional(),
